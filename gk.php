<?php 
session_start();
 $_SESSION['test']="gktest";
 $_SESSION['testtype']="gk";
   ...
   <body>
     <div class="image">
          ...
          <img src="img2.jpg" width="150" height="150">
              ...
              <div class="colmn">
          <span style="color:black;text-align:center;font-size:30px">General Knowledge</span> 
           </div>
     </div>
    ...
    <div class="examnav">
             ...
             <a href="gk.php">General Knowledge </a> » General Knowledge - Random     
